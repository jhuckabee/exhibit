...
Exhibit.CalendarView.prototype.buildCal = function(items){
  var self = this;
...
Exhibit.CalendarView.prototype._fillInfoBubble = function(elmt, itemIDs) {
  var c = SimileAjax.DOM.getPageCoordinates(elmt);
  
  var div = document.createElement("div");
  if (itemIDs.length == 1) {
    this._uiContext.getLensRegistry().createLens(itemIDs[0], div, this._uiContext); 
  }
  else {
    var self = this;
    var accessors = this._accessors;
