...
D.elmt.setAttribute("ex:date",Exhibit.DatePickerFacet.DateUtil.formatDate(C,B._facet._dateFormat));
...
end=Exhibit.DatePickerFacet.DateUtil.parseDate(Exhibit.getAttribute(A,"ex:date"));
