...
SimileAjax.WindowManager.registerEvent(cellLink,"click",function(O,N,P){L._fillInfoBubble(O,[K.itemID]);
...
B.innerHTML=M;
B.href="javascript:{}";
SimileAjax.WindowManager.registerEvent(B,"click",function(Q,P,R){O._fillInfoBubble(E,[D]);
SimileAjax.DOM.cancelEvent(P);
return false;
},SimileAjax.WindowManager.getBaseLayer());
A.appendChild(B);
